...
const ImageDisplay = ({
  ...
  const handleRefresh = () => {
    ...
    // Clear bounding boxes and the image
    onDetection(false);  // This will clear bounding boxes
  };  
  ...
  useEffect(() => {
    if (selectedImage && canvasRef.current) {
      ...
      // Clear the canvas before drawing new image and bounding boxes
      ctx.clearRect(0, 0, canvas.width, canvas.height);
