  ...
  const handleFileChange = (event) => {
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        ...
        setBboxData(null);  // Clear bounding box data when new image is uploaded
      };
    ...
    <div className="flex flex-col w-full h-full bg-customBackground dark:bg-[#ffdc8a] overflow-x-hidden">
      ...
      <div className="hidden lg:flex w-screen h-fit mb-2 overflow-x-hidden z-0 px-4">
        <ImageDisplay
          ...
          onDetection={(detectionOccurred) => {
            if (!detectionOccurred) {
              setBboxData(null);  // Clear bounding box data on refresh
            }
          }}
          theme={theme}
        />
